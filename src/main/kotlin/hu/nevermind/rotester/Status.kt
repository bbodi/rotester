...
enum class Status(intValue: Int? = null) {
    ...
    // Mercenaries
    SP_MERCFLEE(165),
    SP_MERCKILLS(189), SP_MERCFAITH(190),

    // original 1000-
    SP_ATTACKRANGE(1000),
    SP_ATKELE, SP_DEFELE, // 1000-1002
    ...
    init {
        if (intValue != null) {
            enumCounter = intValue
        }
        this.intValue = enumCounter
        if (intValue == null) {
            enumCounter++
        }
    }
    ...
    companion object {
        fun valueOf(intValue: Int): Status = values().first { it.intValue == intValue }
    }
};